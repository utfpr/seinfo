  ...
  <div class="title">
    ...
    <div class="box">
      <form class="form" action="http://localhost:3000/api/pessoa" method="get">
        <div class="row justify-content-center">
          <a-form-item class="space_2">
            ...
            <a-select name="select_evento" defaultValue="0">
              ...
              <a-select-option value="1">Evento 2</a-select-option>
              <a-select-option value="2">Evento 3</a-select-option>
            </a-select>
          </a-form-item>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="row justify-content-center">
          <a-form-item class="space_2">
            <label v-if="value === 2" class="ant-form-item-required">Atividade:</label>
            <a-select v-if="value === 2" name="select_atv" defaultValue="0">
              <a-select-option value="0">Atividade 1</a-select-option>
              <a-select-option value="1">Atividade 2</a-select-option>
              <a-select-option value="2">Atividade 3</a-select-option>
            </a-select>
          </a-form-item>
        </div>
        <div class="row justify-content-center">
          <a-form-item class="space_2">
            <label v-if="value === 2" class="ant-form-item-required">Função:</label>
            <a-select v-if="value === 2" name="select_atv" defaultValue="0">
              <a-select-option value="0">Função 1</a-select-option>
              <a-select-option value="1">Função 2</a-select-option>
              <a-select-option value="2">Função 3</a-select-option>
            </a-select>
          </a-form-item>
          <br>
        </div>
