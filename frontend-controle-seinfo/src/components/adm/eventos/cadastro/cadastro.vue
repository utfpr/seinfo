      ...
      >
        ...
        <div class="row justify-content-center">
          <a-form-item class="space">
            ...
            <a-input
              v-model="obj_Resource.local_eve"
              maxlength="255"
              name="local_eve"
              type="text"
              placeholder="Local"
          ...
          <a-form :form="form" class="space_2">
            ...
            >
              <a-input
                type="date"
                v-decorator="[
                  `data_inicio_lote[${index}]`,
                  { validateTrigger: ['change', 'blur'], preserve: true },
                ]"
                placeholder="Data Inicio do Lote "
              ...
              <a-input
                ...
                placeholder="Valor do Lote R$:00,0"
              />
              <a-button
                type="default"
                style="width: 50%"
                @click="cancelLote(index)"
                >Cancelar Lote</a-button
              >
              <hr />
            </a-form-item>
            <a-form-item v-bind="formItemLayoutWithOutLabel">
              <a-button type="default" style="width: 100%" @click="add"
                >Adicionar Lote</a-button
              >
            </a-form-item>
          </a-form>
        </div>
        ...
        <div class="row justify-content-center">
          <a-form-item class="space_2">
            ...
            <a-textarea
              v-model="obj_Resource.descricao"
              maxlength="5000"
              type="text"
              name="descricao"
        ...
        <div class="row justify-content-center">
          <button type="submit" class="btn btn-outline-primary btn-sm mr-5">
            Cadastrar
          </button>
          <button
            type="reset"
            data-dismiss="modal"
            class="btn btn-outline-danger btn-sm-2"
