<template>
<div class="title">
  <h5 style="text-align:center">Cadastro de Ministrante</h5>
  <div class="box">
    <form class="form" action="http://localhost:3000/ministrante" method="post">
      ...
      <div class="row justify-content-center">
        <a-form-item class="space_2">
          <label class="ant-form-item-required">CPF do Ministrante:</label>
          <a-input type="number" name="cpf_ministrante" placeholder="CPF">
